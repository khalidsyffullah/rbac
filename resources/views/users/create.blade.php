                    ...
                    <div class="card-header bg-white py-3 shadow-sm border-0 rounded-3 mb-5">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="mb-0 text-primary">
                                <i class="bi bi-person-plus-fill me-2"></i>{{ __('Add New User') }}
                            </h5>
                    ...
                    <div class="card-body p-4 shadow border-0 rounded-3">
                        <form class="row g-3 needs-validation" novalidate method="POST"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control shadow-sm" placeholder="Enter full name">
                                @error('name')
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="email" id="email" name="email" class="form-control shadow-sm" placeholder="Enter email address">
                                @error('email')
                                    <span class="text-danger">
                                        <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                                    </span>
